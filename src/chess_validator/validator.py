...
def basic_checks(board, start_row, start_col, end_row, end_col):
    ...
    if not board.is_in_bounds(start_row, start_col) or not board.is_in_bounds(
        end_row, end_col
    ):
        return False
    ...
    if (
        ...
        and destination_piece.colour == moving_piece.colour
    ):
        return False
...
def king_in_check(board, start_row, start_col, end_row, end_col) -> bool:
    ...
    return is_in_check(board_copy, board_copy.turn)
